 ...
 */
final readonly class MakerSearchRequest implements Request
{
    /** API のエンドポイントパス。 */
    ...
    /**
     * @param string      $floorId フロア ID。メーカーが属するフロアを指定する（例: "43"）
     * @param string|null $initial メーカー名かなの前方一致（2 文字以上も指定できる。例: あ、あさ）
